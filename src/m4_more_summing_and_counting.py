...
def run_test_count_cosines_from():
    ...
    # Test 5:
    expected = 2
    answer = count_cosines_from(6, 8, 0.42)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(9, 14, 0.5)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 0.3361  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(8, 10)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 0.65321  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(7, 12)
